...
insert into article (id,title, catalog_id, content, created_at, updated_at)
values
  (1,'文章标题', 9, '我是文章内容', now(), now()),
  (2,'文章标题', 9, '我是文章内容', now(), now()),
  (3,'文章标题', 9, '我是文章内容', now(), now()),
  (4,'文章标题', 10, '我是文章内容', now(), now()),
  (5,'文章标题', 11, '我是文章内容', now(), now()),
  (6,'文章标题', 12, '我是文章内容', now(), now());
